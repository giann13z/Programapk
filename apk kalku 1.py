...
def samadengan():
    ...
    if mtk == "penjumlahan":
        ...
        angka_akhir = float(nomor_akhir)
        hasil = n_awal * (angka_akhir / 100)
        e.insert(0, hasil)
...
tam  = Button(root,text="+",padx = 30,bg="#FFA500",fg="white", pady = 20,command=tambah)
kur  = Button(root,text="-",padx = 30,bg="#FFA500",fg="white", pady = 20,command=kurang)
bag  = Button(root,text="/",padx = 30,bg="#FFA500",fg="white", pady = 20,command=bagi)
kal  = Button(root,text="x",padx = 30,bg="#FFA500",fg="white", pady = 20,command=kali)
...
pers = Button(root,text="%",padx = 30,bg="#878787",fg="white", pady = 20,command=persen)
hap  = Button(root,text="C",padx = 30,bg="#878787",fg="white", pady = 20,command=hapus)
equal = Button(root,text="=",padx = 60,bg="#FFA500", pady = 20,command=samadengan)
...
pers.grid(row =4,column=2,pady=2)
